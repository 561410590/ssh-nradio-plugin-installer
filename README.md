...
- 切换前专用备份保存在 `/root/.nradio-plugin-menu/hnat-backups/`；切换或验收失败自动恢复，并报告恢复结果。开启和关闭均持久保存。
- 版本日期为 `2026-09-12`；模拟测试覆盖开关、菜单、状态读取与失败恢复，实机效果按设备验收。
...
```text
SHA256  0cdf7fd434f2a3ce773f4c3473fdad44be5995779bd3804bf8c377548b1fe20c
Bytes   2813977
